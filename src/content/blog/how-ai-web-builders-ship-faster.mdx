...
pubDate: "2026-05-17T09:20:00Z"
heroImage: '../../assets/images/banner.jpg'
category: "AI & Web Development"
tags: ['Cursor', 'Astro', 'Generative AI', 'Web Development']
draft: false
---
...
A common mistake is giving a prompt like: _"Redesign my homepage to look modern and premium."_
...
1. _"Keep Astro 4 and Tailwind 3."_
2. _"Do not install new dependencies."_
3. _"Modify the existing `src/pages/index.astro` grid from 1 column to a 12-column 3-6-3 layout."_
