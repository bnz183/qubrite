...
tags: ['Astro', 'MDX', 'Cloudflare', 'Architecture']
draft: false
---
...
- You can easily write automation scripts (via n8n or local Node scripts) that generate and format `.mdx` files directly.
